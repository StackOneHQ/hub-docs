...
<Steps>
  <Step title="To access the result of an assessment">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Job Requisition Fields" src="/images/sapsuccessfactors/assessment/sapsuccessfactors_updated_results_on SAP_UI_46.png" />
    </Frame>
  </Step>
</Steps>
