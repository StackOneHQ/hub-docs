...
<Steps>
  <Step title="Go to Job Requisition">
    ...
    Click on the link labeled `Add More Assessments` to make the dropdown fields visible.
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="enable dropdown fields" src="/images/sapsuccessfactors/assessment/sapsf_assess_add_more_assessments_15.png" />
    </Frame>
