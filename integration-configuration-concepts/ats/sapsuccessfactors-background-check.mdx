...
<Steps>
  ...
  <Step title="Configure Fields Step">
    ...
    <Info>
      Please refer the mapping listed <a href="#please-follow-the-mapping-below-to-receive-the-correct-order-notification">here</a>.
    </Info>
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Select option to map fields" src="/images/sapsuccessfactors/background-check/sap_sf_bc_integrtion_center_config_fields_54.png" />
    </Frame>
