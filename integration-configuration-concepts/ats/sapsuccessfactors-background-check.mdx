...
<Steps>
  ...
  <Step title="Send Background Check to Candidate">
    ...
    <Accordion title="Users involved in recruiting must have the necessary permissions to initiate background checks.">
      <Warning>
        You have access to Provisioning. As a Recruiter, you may not have access to Provisioning. To complete tasks in Provisioning, contact your implementation partner or Account Executive. 
        
        For any non-implementation tasks, contact Technical Support of SAP SF.
      </Warning>

      Go to _Provisioning_ > _Managing Recruiting_ > _Import/Update/Export Job Requisition Template_ and Add the feature permission block for background check to the job requisition template.
