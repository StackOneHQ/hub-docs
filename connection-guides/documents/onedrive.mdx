---
title: "OneDrive"
description: "How to obtain the credentials required to connect to Onedrive."
---
...
<Steps>
  <Step title="Get your OneDrive Base URL">
    Your OneDrive base URL follows this format:
    ...
    1. Opening your Microsoft OneDrive site
  ...
  <Step title="Obtain your Tenant ID">
    ...
    **Copy** <Icon icon="clipboard" color="#333333" /> the Tenant ID and store safely to be used in a later step:
    ...
    ![Ms Entra App Client Tenant Ids OneDrive Pn](/images/sharepoint/tenant-id.png)
  </Step>
