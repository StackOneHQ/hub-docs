...
<Steps>
  ...
  <Step title="Add a new API key">
    ...
    <Frame>
      <img className='rounded-md' style={{ width: '400px', margin: '0 auto', border: '1px solid #efefef' }} alt="API Tokens page" src="/images/zendesk/image2.png" />
    </Frame>
  </Step>
  ...
  <Step title="Enter a description and generate the token">
    ...
    Once the token is generated, it will be displayed on the screen. Make sure to copy it immediately, as you won't be able to see it again.   
      <Frame>
        <img className='rounded-md' style={{ width: '400px', margin: '0 auto', border: '1px solid #efefef' }} alt="API Key dialog" src="/images/zendesk/image3.png" />
      </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter your credentials">
    Select <b>Zendesk</b> from the list of available integrations.(if not available, you can enable it from the Integrations section)
  </Step>

  <Step title="Fill in the required fields">
    Enter your Zendesk subdomain, email, and the API token you generated earlier. Ensure that all fields are filled out correctly.
  </Step>
