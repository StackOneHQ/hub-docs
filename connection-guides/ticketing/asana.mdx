...
This will require Personal Access Token you just generated and workspace ID.
...
<Steps>
  ...
  <Step title="Save and connect">
    Select the Asana from the list and fill the required details - Personal Access Token and Workspace ID.
