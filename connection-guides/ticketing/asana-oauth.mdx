...
<Steps>
  <Step title="Save the integration settings">
    Go to the StackOne Hub > Integrations section and Fill in the required fields with the Client ID, Client Secret, Scopes (optional), and Workspace ID for Asana integration.
