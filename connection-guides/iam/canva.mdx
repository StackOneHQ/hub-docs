...
<Steps>
  <Step title="Log in to Canva">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Account Settings" src="/images/canva-iam/image1.png" />
    </Frame>
  </Step>
  ...
  <Step title="SSO & Provisioning">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="SSO & Provisioning" src="/images/canva-iam/image2.png" />
    </Frame>
  </Step>
  ...
  <Step title="Get Info from Identity Provider">
    ...
    <ul>
      <li>SAML 2.0 Endpoint (HTTP): `https://stackone.com/idp/endpoint/HttpPost`</li>
      <li>Identity Provider Issuer: `StackOne`</li>
      <li>x.509 Public Certificate:
    ...
    Note that this is an unused public certificate, and StackOne only performs Read operations in this connection. Click Save changes for Canva to validate the input.
  </Step>
  ...
  <Step title="Enable SCIM Provisioning">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="SCIM Provisioning" src="/images/canva-iam/image3.png" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Enter SCIM Key">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/canva-iam/image4.png" />
    </Frame>
  </Step>
