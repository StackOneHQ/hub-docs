...
<Steps>
  ...
  <Step title="Enter App Details">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="App Details" src="/images/webex/image6.png" />
    </Frame>
  </Step>
  ...
  <Step title="Add Integration">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Add Integration" src="/images/webex/image7.png" />
    </Frame>
  </Step>
  ...
  <Step title="Copy Client ID and Client Secret">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Client ID and Client Secret" src="/images/webex/image8.png" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Enter Authentication Details">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/webex/image9.png" />
    </Frame>
  </Step>
