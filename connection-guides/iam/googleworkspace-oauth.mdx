...
Log in to your Google Workspace Admin Console at https://admin.google.com/login
...
<Steps>
    ...
    <Step title="Select Required Application Scopes">
        Click the **Add or Remove Scopes** button. A panel will appear on the right titled *Update selected scopes*.
...
<Steps>
  ...
  <Step title="Grant OAuth Application Consent">
    ...
    After logging in, you will see the OAuth consent screen you configured in a [previous step](#configure-oauth-consent).
...
This integration provides access to the following [IAM Resources](https://docs.stackone.com/reference/getting-started-with-your-api) from Google Workspace:
<ul>
 <li>Users</li>
 <li>Groups</li>
 <li>Roles</li>
