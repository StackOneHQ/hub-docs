...
<Steps>
  ...
  <Step title="Enter API Key details">
    Enter API key description and expiry date and click on `Generate`.
    <Frame>
...
<Steps>
  <Step title="Enter Credentials">
    Upon reaching the Link Account page, enter the API key and tenat name from previous steps and proceed by clicking the <b>Connect</b> button.
    <Frame>
