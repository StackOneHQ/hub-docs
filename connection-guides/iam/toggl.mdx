---
title: "Toggl"
description: "How to obtain the credentials required to connect to Toggl."
---
...
<Steps>
  <Step title="Enter API Token and Organization ID">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/toggl/image4.png" />
    </Frame>
  </Step>
