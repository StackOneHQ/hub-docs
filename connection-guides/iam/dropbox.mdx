---
title: "Dropbox"
description: "How to obtain the credentials required to connect to Dropbox."
---
...
<Steps>
  <Step title="Enter Credentials">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/dropbox/image5.png" />
    </Frame>
  </Step>
