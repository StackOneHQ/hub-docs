...
## Linking your Cornerstone Account
...
<Steps>
  ...
  <Step title="Find Cornerstone">
    Search for Cornerstone in the list of available integrations and click on it.
  </Step>
  ...
  <Step title="Test and Save">
    Click Test Connection to verify the connection, then click Save to complete the integration. If you encounter any errors:
