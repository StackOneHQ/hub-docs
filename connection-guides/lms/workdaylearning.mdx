...
<Steps>
  ...
  <Step title="Accessing View Drive">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Accessing View Drive" src="/images/workday/workday-homepage.jpg" />
    </Frame>
  ...
  <Step title="Initiating File Upload">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Initiating File Upload" src="/images/workday/workday-view-drive.jpg" />
    </Frame>
  ...
  <Step title="Selecting the File to Upload">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Selecting the File to Upload" src="/images/workday/workday-upload-asset.jpg" />
    </Frame>
  ...
  <Step title="Completing the Upload Process">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Completing the Upload Process" src="/images/workday/workday-uploaded-asset.jpg"/>
    </Frame>
  ...
  <Step title="Retrieving Workday ID">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Retrieving Workday ID" src="/images/workday/workday-copy-asset-id.jpg" />
    </Frame>
