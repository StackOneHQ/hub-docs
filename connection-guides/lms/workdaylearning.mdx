...
<Steps>
  <Step title="Edit Permissions">
    Edit the Domain Security Policy Permissions in the Security Group. Add the GET and PUT/MANAGE operations for the following required permissions for the LMS API:

    For integrating with the LMS functionalities of Workday

    - Learning Enrollment/s
    - Learning Digital Course
    - Learning Topics
