...
<Steps>
  <Step title="Locate API Password">
    In the SuccessFactors main instanc, navigate to the user management tool.

    Search for the integration system user and find the password within the user profile.

    I required you can reset the password by searching *Reset User Password* in the search bar.
