...
<Steps>
  <Step title="Set lms_user_id Field">
    ...
    This is the primary and recommended approach for user identification in SAP SuccessFactors.
  </Step>
...
<Steps>
  <Step title="Configure External Reference Field">
    If the `lms_user_id` custom field cannot be configured to the UserID, configure an additional field called `lms_external_reference_field` to map to the **personExternalID** field.
