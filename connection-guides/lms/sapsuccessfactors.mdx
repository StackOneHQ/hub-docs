...
## Finding the Learning Hub URL
  ...
  **If you are setting up SAP for creating content via OCN, please follow the below steps to create an OCN Admin Role and User and use that username, password and client secret.**
  <Steps>
...
<Steps>
  <Step title="Add New Administrator">
    ...
    **Take note of this client secret as this will be used to connect the account in the StackOne hub.**
