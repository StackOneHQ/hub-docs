...
#### lms_user_id Configuration

The primary approach for SSO configuration is to use the `lms_user_id` field:

<Steps>
  <Step title="Set lms_user_id Field">
    Configure a custom field called `lms_user_id` and set it to the **UserID** field value.
    
    This is the primary approach and should be implemented whenever possible.
  </Step>
  
  <Step title="Verify Configuration">
    Work with your content provider to verify that the `lms_user_id` field is properly configured and populated.
...
<Steps>
  <Step title="Set Custom Field">
    If the primary lms_user_id configuration is not possible, configure a custom field and set it to the **UserID** field value.
  </Step>
  
  <Step title="Verify Custom Field">
    Ensure the custom field is properly populated and accessible through the SSO configuration.
  </Step>
</Steps>
