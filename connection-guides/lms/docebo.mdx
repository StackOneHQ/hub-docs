...
<Note>
  Administrator access is required in your Docebo account to create OAuth applications and manage settings.
</Note>
...
- **Subdomain/Domain** (from Step 6)
- **Username** (your Docebo username)
- **Password** (your Docebo password)
- **Catalog ID** (from Step 7, optional)
