...
<Steps>
  <Step title="Find the Subdomain">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Subdomain Example" src="/images/eploy/image1.png" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Navigate to API Keys">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Create API Key" src="/images/eploy/image2.png" />
    </Frame>
  </Step>
  ...
  <Step title="Create a New API Key">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Create API Key" src="/images/eploy/image3.png" />
    </Frame>
  </Step>
  ...
  <Step title="Name the API Key">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Create API Key" src="/images/eploy/image4.png" />
    </Frame>
  </Step>
  ...
  <Step title="Record Client ID, Client Secret and Assign Permissions">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Generated API Key" src="/images/eploy/image5.png" />
    </Frame>

    Choose the APIs and the necessary permissions, then click `Save`.

    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Generated API Key" src="/images/eploy/image6.png" />
    </Frame>
...
<Steps>
  <Step title="Enter the Details">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/eploy/image7.png" />
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/eploy/image8.png" />
    </Frame>
