...
description: "To successfully set up a webhook for a Workday Assessment, follow these steps to understand the end-to-end process and configurations, including the necessary actions for webhook notification."
---
...
<Steps>
  ...
  <Step title="Verify the integration on the Workday">
