...
- **Docebo**: Use Primary email or Employee ID for the user identifier
- **Cornerstone OnDemand**: May require Employee ID or custom identifier
- **SAP SuccessFactors**: Typically uses Primary email or username-based identifiers
- **Workday Learning**: Often requires Employee ID or custom identifier
- **360Learning**: Usually accepts Primary email
