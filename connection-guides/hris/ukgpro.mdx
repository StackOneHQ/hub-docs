...
## Getting your UKG Company Domain and Subdomain
...
<Step title="Copy Domain">
    Copy the domain from any Web Services URL. For example, if your URL is `http://Servicet.ultipro.com/services/BIDataService`, copy `ultipro.com`.
    ...
    <Frame>
      <img
        ...
        src="/images/ukgpro/ukgpro-domain.png"
      />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Enter Details">
    ...
    - Web Service Domain (from Step 1)
