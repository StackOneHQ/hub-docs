...
<Steps>
  ...
  <Step title="Assign Permissions">
    ...
    <ul>
    <li>
    Personnel Integration</li>

    
    <li>
    Employee Job History Details</li>

    
    <li>
    Employee Employment Information</li>

    
    <li>
    Employee Person Details</li>

    
    <li>
    Employee Compensation Details</li>

    
    <li>
    Company Configuration Integration</li>
  ...
  <Step title="Save Service User Credentials">
    ...
    - Service Account User API Key
    
      ![Ukg Pro Service User Api Key Pn](/images/ukg-pro-service-user-api-key.png)
  </Step>
</Steps>
