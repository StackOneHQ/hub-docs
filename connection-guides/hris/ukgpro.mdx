...
<Steps>
  <Step title="Login to UKG Pro">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Web Services Search" src="/images/ukgpro/image1.png" />
    </Frame>
  </Step>
  ...
  <Step title="Copy Subdomain">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Subdomain Example" src="/images/ukgpro/image2.png" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Search for Service Account Administration">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Service Account Administration" src="/images/ukgpro/image3.png" />
    </Frame>
  </Step>
  ...
  <Step title="Copy Customer API Key">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Customer API Key" src="/images/ukgpro/image4.png" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Add Service Account">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Add Service Account" src="/images/ukgpro/image5.png" />
    </Frame>
  </Step>
  ...
  <Step title="Enter Admin Details">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Admin Details" src="/images/ukgpro/image6.png" />
    </Frame>
  </Step>
  ...
  <Step title="Assign Permissions">
    ...
    <ul>
      <li>Personnel Integration</li>
      <li>Employee Job History Details</li>
      <li>Employee Employment Information</li>
      <li>Employee Person Details</li>
      <li>Employee Compensation Details</li>
      <li>Company Configuration Integration</li>
    </ul>
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Assign Permissions" src="/images/ukgpro/image7.png" />
    </Frame>
  </Step>
  ...
  <Step title="Save and Generate Password">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Generate Password" src="/images/ukgpro/image8.png" />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Enter Details">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/ukgpro/image9.png" />
    </Frame>
  </Step>
</Steps>
