...
<Steps>
  <Step title="Edit Permissions">
    ...
    <Info>
      The Workday HRIS integration currently requires **all** of the permissions listed below to be enabled. 
    ...
    Enable the **GET** operations for the following required permissions for the HRIS API:
