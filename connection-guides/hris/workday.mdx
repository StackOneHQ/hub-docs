---
title: "Workday"
description: "How to obtain the credentials required to connect to Workday."
---

import IntegrationFooter from "/snippets/integration-footer.mdx";

<Note>
  Administrator access is required in your Workday account to access web services and system information.
</Note>
