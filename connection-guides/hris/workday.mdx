...
<Steps>
  <Step title="Edit Permissions">
    Edit the Domain Security Policy Permissions in the Security Group. Add the GET operations for the following required permissions for the full HRIS & ATS API:

    For integrating with the HRIS functionalities of Workday
    ...
    For integrating with the ATS functionalities of Workday
