...
description: "How to obtain the credentials required to connect to Hibob Service User."
---
...
<Frame>
  <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Feature permission for its Time Off subsection" src="/images/hibob-service-user/image_features_time_off.png" />
</Frame>
- Settings
...
<Info>
  The permissions above do not include **Custom Fields** configured in your Account. Please make sure to grant View and/or Edit permissions for all **Custom Fields** to be included in this integration.
</Info>
