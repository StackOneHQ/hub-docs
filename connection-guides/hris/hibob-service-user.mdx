...
<Steps>
  ...
  <Step title="Finish Creation">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Service User Created" src="/images/hibob-service-user/image5.png" />
    </Frame>
  </Step>
</Steps>
...
[Creating a Custom Permissions Group](https://help.hibob.com)
...
<Steps>
  <Step title="Navigate to Permissions Groups">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Permissions Groups" src="/images/hibob-service-user/image6.png" />
    </Frame>
  </Step>
  ...
  <Step title="Edit Permissions Group">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Edit Details" src="/images/hibob-service-user/image7.png" />
    </Frame>
  </Step>
  ...
  <Step title="Select People By Condition">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Select People By Condition" src="/images/hibob-service-user/image8.png" />
    </Frame>
  </Step>
  ...
  <Step title="Add Specific Employees">
    ...
    <Frame>
      <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Add Specific Employees" src="/images/hibob-service-user/image9.png" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Link Account" src="/images/hibob-service-user/image10.png" />
</Frame>
