...
<Frame>
  <img className='rounded-md' style={{ margin: '0 auto', border: '1px solid #efefef' }} alt="Feature permission for its Time Off subsection" src="/images/hibob-service-user/image_features_time_off-05-26at09.46.40.png" />
</Frame>
- Settings
