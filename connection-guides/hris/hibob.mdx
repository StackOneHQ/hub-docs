...
<Steps>
  ...
  <Step title="Enable Approved Scopes">
    ...
    **Additional permissions for Time Off functionality:**
    - `People > Lifecycle > View selected employees' Lifecycle section histories` (Required for lifecycle events)
    - `Time off > See who's out today > See who's out because of private policy` (Optional)
    <Frame>
