...
<Steps>
  ...
  <Step title="Generate OAuth Client Credentials">
    ...
    - **Security Profile:** Select `Employee`.
    - **Account Groups:** Click on the `List Group` icon to select one of the groups you have created with the required permissions.
